...
// list (ordered fairly optimally) by a noddy build tool and just #included here:
    ...
    char j[] = "DEAT"; DEAT_tag = new GEDCOM_tag(i);
    char k[] = "NOTE"; NOTE_tag = new GEDCOM_tag(k);
    char l[] = "FAM"; FAM_tag = new GEDCOM_tag(l);
    char m[] = "HUSB"; HUSB_tag = new GEDCOM_tag(m);
    char n[] = "WIFE"; WIFE_tag = new GEDCOM_tag(n);
    char o[] = "PLAC"; PLAC_tag = new GEDCOM_tag(o);
    char p[] = "SOUR"; SOUR_tag = new GEDCOM_tag(p);
    char q[] = "MARR"; MARR_tag = new GEDCOM_tag(q);
    char r[] = "BURI"; BURI_tag = new GEDCOM_tag(r);
    char s[] = "SITE"; SITE_tag = new GEDCOM_tag(s);
    char t[] = "CEME"; CEME_tag = new GEDCOM_tag(t);
    char u[] = "TITL"; TITL_tag = new GEDCOM_tag(u);
    char v[] = "TIME"; TIME_tag = new GEDCOM_tag(v);
    char w[] = "BAPM"; BAPM_tag = new GEDCOM_tag(w);
    char x[] = "CHR"; CHR_tag = new GEDCOM_tag(x);
    char y[] = "CREM"; CREM_tag = new GEDCOM_tag(y);
    char z[] = "CAUS"; CAUS_tag = new GEDCOM_tag(z);
    char A[] = "PLOT"; PLOT_tag = new GEDCOM_tag(A);
    char B[] = "AGE"; AGE_tag = new GEDCOM_tag(B);
    char C[] = "FIDE"; FIDE_tag = new GEDCOM_tag(C);
    char D[] = "QUAY"; QUAY_tag = new GEDCOM_tag(D);
    char E[] = "ORIG"; ORIG_tag = new GEDCOM_tag(E);
    char F[] = "CLAS"; CLAS_tag = new GEDCOM_tag(F);
    char G[] = "OCCU"; OCCU_tag = new GEDCOM_tag(G);
    char H[] = "EVEN"; EVEN_tag = new GEDCOM_tag(H);
    char I[] = "PUBL"; PUBL_tag = new GEDCOM_tag(I);
    char J[] = "TEXT"; TEXT_tag = new GEDCOM_tag(J);
    char K[] = "PHOTO"; PHOTO_tag = new GEDCOM_tag(K);
    char L[] = "TYPE"; TYPE_tag = new GEDCOM_tag(L);
    char M[] = "PUBR"; PUBR_tag = new GEDCOM_tag(M);
    char N[] = "CONC"; CONC_tag = new GEDCOM_tag(N);
    char O[] = "PAGE"; PAGE_tag = new GEDCOM_tag(O);
    char P[] = "REPO"; REPO_tag = new GEDCOM_tag(P);
    char Q[] = "CNTC"; CNTC_tag = new GEDCOM_tag(Q);
    char R[] = "ADDR"; ADDR_tag = new GEDCOM_tag(R);
    char S[] = "ENGA"; ENGA_tag = new GEDCOM_tag(S);
    char T[] = "DIV"; DIV_tag = new GEDCOM_tag(T);
    char U[] = "INFT"; INFT_tag = new GEDCOM_tag(U);
    char V[] = "MARL"; MARL_tag = new GEDCOM_tag(V);
    char W[] = "VERS"; VERS_tag = new GEDCOM_tag(W);
    char X[] = "GEDC"; GEDC_tag = new GEDCOM_tag(C);
    char Y[] = "HEAD"; HEAD_tag = new GEDCOM_tag(Y);
    char Z[] = "TRLR"; TRLR_tag = new GEDCOM_tag(Z);
