...
I used the 2019 version of GEDCOM, see <a href="https://www.tamurajones.net/GEDCOM555JustARevision.xhtml">GEDCOM 5.5.5 discussion</a>:
"the GEDCOM 5.5.1 specification includes support for a few new useful record types, such as those for email and web addresses, 
it is no more than a revision of GEDCOM 5.5, which was released on 11 Dec 1995, almost a quarter century ago.
